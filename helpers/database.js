...
/**
 * Runs an SQL query against the DB, end the connection and return the result.
...
exports.run_query = async function run_query(query, values) {
  try {
    ...
    /**
     * Doesn't let unknown errors propagate up to the response object
     * as it may contain sensitive server information.
     * Instead it logs it somehow and throw a generic error.
     */
